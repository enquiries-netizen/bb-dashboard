export default async function handler(req, res) {
  ...
  const PAGE_DIRECTORY = pageDirectory || {
    ...
    P12: 'Site Diaries (crew full-width diary summaries). Google sign-in + Staff_Access. No Ask BB. Week list+detail; photos column P only; Daily Summary (col Q) when present for any entry. Variations description only. Not merged with P11. No Gantt/charts/financials.',
  };
