export default async function handler(req, res) {
  ...
  const PAGE_DIRECTORY = pageDirectory || {
    ...
    P12: 'Site Diaries (crew-only handoff). Staff-gated. No Ask BB on this page. Condensed job-day summaries from Buildpass_Site Diaries; full Issues/Blockers and safety text; photo links when URLs exist; Variations description+status only NEVER dollar values. Entries without job # stay. Meli weekly record Pending. Not merged with P11 quality dashboard. No Gantt, no financials.',
  };
