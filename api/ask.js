export default async function handler(req, res) {
  ...
  const PAGE_DIRECTORY = pageDirectory || {
    ...
    P12: 'Site Diaries (crew-only handoff). Staff-gated. No Ask BB on this page. Condensed job-day summaries from Buildpass_Site Diaries; Issues/Blockers and Safety expand for free-text detail; Site Diary PDF link or No PDF attached; Variations description+status only NEVER dollar values. Entries without job # stay. Meli weekly record from Job Name Melis Record Keeping for selected week. Not merged with P11 quality dashboard. No Gantt, no financials.',
  };
