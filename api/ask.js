export default async function handler(req, res) {
  ...
  const PAGE_DIRECTORY = pageDirectory || {
    ...
    P12: 'Site Diaries (crew-only week-driven reports). Google sign-in + Staff_Access. No Ask BB on this page. Week selector lists report entry points (Job # groups + person-only specials with no Job # such as Melis Record Keeping and Fabrication and Welding). PDF-first via Site Diary PDF column into PDF.js lightbox; if no PDF show Report not yet available for this job/week plus optional real work-completed lines only. NEVER variations, dollar values, or invented narratives. Not merged with P11. No Gantt, no charts, no financials.',
  };
