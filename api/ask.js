export default async function handler(req, res) {
  ...
  const PAGE_DIRECTORY = pageDirectory || {
    ...
    P12: 'Site Diaries (crew full-width diary summaries). Google sign-in + Staff_Access. No Ask BB on this page. Week list+detail day notes; photos from column P only. Column Q Deliveries Made Today text when present (Meli). Variations description only (no dollars). Not merged with P11. No Gantt, charts, or financials.',
  };
